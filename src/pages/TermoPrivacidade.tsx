      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              Esta Política de Privacidade descreve como o sistema Zeelux coleta, usa, armazena e protege 
              suas informações pessoais. Estamos comprometidos em proteger sua privacidade e garantir a 
              segurança dos seus dados pessoais.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">2. Informações Coletadas</h2>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li><strong>Dados de Uso:</strong> Informações sobre como você utiliza o sistema</li>
              <li><strong>Dados Comerciais:</strong> Pedidos, produtos, transações, histórico de compras</li>
              <li><strong>Dados de Clientes:</strong> Informações fornecidas sobre seus clientes</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Processar transações e gerenciar pedidos</li>
              <li>Melhorar, personalizar e expandir nosso sistema</li>
              <li>Comunicar com você sobre atualizações e ofertas</li>
              <li>Enviar informações administrativas e de suporte</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong>Prestadores de Serviços:</strong> Empresas que nos auxiliam na operação do sistema</li>
              <li><strong>Parceiros Comerciais:</strong> Como plataformas de pagamento e logística</li>
            ...
            <p className="mt-2">
              ...
              de marketing sem seu consentimento explícito.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Seus dados são armazenados em servidores seguros e mantidos pelo tempo necessário para 
          ...
          <section>
            ...
            <p>
              ...
              do sistema e personalizar conteúdo. Você pode configurar seu navegador para recusar cookies, 
              mas isso pode afetar algumas funcionalidades do sistema.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">9. Alterações na Política</h2>
            <p>
              Podemos atualizar esta Política de Privacidade periodicamente. Notificaremos sobre mudanças 
              significativas através do sistema ou por e-mail. A continuação do uso após as alterações 
              constitui aceitação da nova política.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">10. Contato e DPO</h2>
            <p className="mb-2">
            ...
            <ul className="list-none space-y-1 ml-4">
              <li>E-mail: dpo@zeelux.com</li>
              <li>Prazo de resposta: até 15 dias úteis</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">11. Base Legal</h2>
            <p className="mb-2">O tratamento de dados pessoais é realizado com base em:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
